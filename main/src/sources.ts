...
import matcapNavy from "./assets/textures/matcap-navy.png";
import matcapBeige from "./assets/textures/matcap-beige.png";
...
export const sources = [
  ...
  { name: "matcap-navy", type: "texture", path: matcapNavy },
  { name: "matcap-beige", type: "texture", path: matcapBeige },
